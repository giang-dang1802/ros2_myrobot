...
private:
    ...
    rclcpp::Node::SharedPtr lift_node_;
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr lift_sub_;
    std::string pending_lift_cmd_;   // Lưu lệnh LIFT chờ gửi
    std::mutex lift_mutex_; 
