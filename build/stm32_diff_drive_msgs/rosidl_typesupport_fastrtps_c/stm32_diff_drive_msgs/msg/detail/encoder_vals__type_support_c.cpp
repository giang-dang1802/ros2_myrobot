...
#include "stm32_diff_drive_msgs/msg/detail/encoder_vals__rosidl_typesupport_fastrtps_c.h"
...
using _EncoderVals__ros_msg_type = stm32_diff_drive_msgs__msg__EncoderVals;
...
size_t get_serialized_size_stm32_diff_drive_msgs__msg__EncoderVals(
  const void * untyped_ros_message,
...
static uint32_t _EncoderVals__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_diff_drive_msgs__msg__EncoderVals(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_diff_drive_msgs
size_t max_serialized_size_stm32_diff_drive_msgs__msg__EncoderVals(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_diff_drive_msgs__msg__EncoderVals;
    is_plain =
      (
...
static size_t _EncoderVals__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_diff_drive_msgs__msg__EncoderVals(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_diff_drive_msgs, msg, EncoderVals)() {
