...
#include "stm32_diff_drive_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
#include "stm32_diff_drive_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MotorCommand__ros_msg_type = stm32_diff_drive_msgs__msg__MotorCommand;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_diff_drive_msgs
size_t get_serialized_size_stm32_diff_drive_msgs__msg__MotorCommand(
  const void * untyped_ros_message,
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_stm32_diff_drive_msgs__msg__MotorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_stm32_diff_drive_msgs
size_t max_serialized_size_stm32_diff_drive_msgs__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_diff_drive_msgs__msg__MotorCommand;
    is_plain =
      (
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_stm32_diff_drive_msgs__msg__MotorCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stm32_diff_drive_msgs, msg, MotorCommand)() {
