...
{
  new (message_memory) stm32_diff_drive_msgs::msg::MotorCommand(_init);
}

void MotorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<stm32_diff_drive_msgs::msg::MotorCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorCommand_message_member_array[3] = {
  {
    ...
    offsetof(stm32_diff_drive_msgs::msg::MotorCommand, is_pwm),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stm32_diff_drive_msgs::msg::MotorCommand, mot_1_req_rad_sec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stm32_diff_drive_msgs::msg::MotorCommand, mot_2_req_rad_sec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorCommand_message_members = {
  "stm32_diff_drive_msgs::msg",  // message namespace
  "MotorCommand",  // message name
  3,  // number of fields
  sizeof(stm32_diff_drive_msgs::msg::MotorCommand),
...
get_message_type_support_handle<stm32_diff_drive_msgs::msg::MotorCommand>()
{
  return &::stm32_diff_drive_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stm32_diff_drive_msgs, msg, MotorCommand)() {
  return &::stm32_diff_drive_msgs::msg::rosidl_typesupport_introspection_cpp::MotorCommand_message_type_support_handle;
}
