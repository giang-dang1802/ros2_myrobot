...
{
  new (message_memory) stm32_diff_drive_msgs::msg::EncoderVals(_init);
}

void EncoderVals_fini_function(void * message_memory)
{
  auto typed_message = static_cast<stm32_diff_drive_msgs::msg::EncoderVals *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EncoderVals_message_member_array[2] = {
  {
    ...
    offsetof(stm32_diff_drive_msgs::msg::EncoderVals, mot_1_enc_val),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(stm32_diff_drive_msgs::msg::EncoderVals, mot_2_enc_val),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EncoderVals_message_members = {
  ...
  2,  // number of fields
  sizeof(stm32_diff_drive_msgs::msg::EncoderVals),
...
{
  return &::stm32_diff_drive_msgs::msg::rosidl_typesupport_introspection_cpp::EncoderVals_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stm32_diff_drive_msgs, msg, EncoderVals)() {
  return &::stm32_diff_drive_msgs::msg::rosidl_typesupport_introspection_cpp::EncoderVals_message_type_support_handle;
}
