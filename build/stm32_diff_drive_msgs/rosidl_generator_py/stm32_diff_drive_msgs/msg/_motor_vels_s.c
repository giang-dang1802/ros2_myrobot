...
bool stm32_diff_drive_msgs__msg__motor_vels__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stm32_diff_drive_msgs.msg._motor_vels.MotorVels", full_classname_dest, 47) == 0);
  }
  stm32_diff_drive_msgs__msg__MotorVels * ros_message = _ros_message;
  {  // mot_1_rad_sec
...
PyObject * stm32_diff_drive_msgs__msg__motor_vels__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stm32_diff_drive_msgs.msg._motor_vels");
