...
bool stm32_diff_drive_msgs__msg__motor_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("stm32_diff_drive_msgs.msg._motor_command.MotorCommand", full_classname_dest, 53) == 0);
  }
  stm32_diff_drive_msgs__msg__MotorCommand * ros_message = _ros_message;
  {  // is_pwm
...
PyObject * stm32_diff_drive_msgs__msg__motor_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("stm32_diff_drive_msgs.msg._motor_command");
