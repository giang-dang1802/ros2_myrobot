...
#ifndef STM32_DIFF_DRIVE_MSGS__MSG__DETAIL__MOTOR_COMMAND__TRAITS_HPP_
#define STM32_DIFF_DRIVE_MSGS__MSG__DETAIL__MOTOR_COMMAND__TRAITS_HPP_
...
inline void to_yaml(
  const stm32_diff_drive_msgs::msg::MotorCommand & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const stm32_diff_drive_msgs::msg::MotorCommand & msg)
{
  return stm32_diff_drive_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<stm32_diff_drive_msgs::msg::MotorCommand>()
{
  return "stm32_diff_drive_msgs::msg::MotorCommand";
}

template<>
inline const char * name<stm32_diff_drive_msgs::msg::MotorCommand>()
{
  return "stm32_diff_drive_msgs/msg/MotorCommand";
}

template<>
struct has_fixed_size<stm32_diff_drive_msgs::msg::MotorCommand>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<stm32_diff_drive_msgs::msg::MotorCommand>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<stm32_diff_drive_msgs::msg::MotorCommand>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // STM32_DIFF_DRIVE_MSGS__MSG__DETAIL__MOTOR_COMMAND__TRAITS_HPP_
