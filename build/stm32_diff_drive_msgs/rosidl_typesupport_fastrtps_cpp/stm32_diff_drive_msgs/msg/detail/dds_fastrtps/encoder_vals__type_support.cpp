...
#include "stm32_diff_drive_msgs/msg/detail/encoder_vals__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_diff_drive_msgs::msg::EncoderVals & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_diff_drive_msgs::msg::EncoderVals & ros_message)
{
  // Member: mot_1_enc_val
  cdr >> ros_message.mot_1_enc_val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_diff_drive_msgs::msg::EncoderVals;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_diff_drive_msgs::msg::EncoderVals *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_diff_drive_msgs::msg::EncoderVals *>(
    untyped_ros_message);
...
get_message_type_support_handle<stm32_diff_drive_msgs::msg::EncoderVals>()
{
  return &stm32_diff_drive_msgs::msg::typesupport_fastrtps_cpp::_EncoderVals__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_diff_drive_msgs, msg, EncoderVals)() {
  return &stm32_diff_drive_msgs::msg::typesupport_fastrtps_cpp::_EncoderVals__handle;
}
