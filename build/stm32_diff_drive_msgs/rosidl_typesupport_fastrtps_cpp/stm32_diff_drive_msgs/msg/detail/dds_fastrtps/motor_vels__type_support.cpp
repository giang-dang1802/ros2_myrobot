...
#include "stm32_diff_drive_msgs/msg/detail/motor_vels__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_diff_drive_msgs::msg::MotorVels;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_diff_drive_msgs::msg::MotorVels *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_diff_drive_msgs::msg::MotorVels *>(
    untyped_ros_message);
...
{
  return &stm32_diff_drive_msgs::msg::typesupport_fastrtps_cpp::_MotorVels__handle;
}
