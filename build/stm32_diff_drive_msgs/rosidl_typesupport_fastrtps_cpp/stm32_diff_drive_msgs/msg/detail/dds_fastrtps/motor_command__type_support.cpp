...
#include "stm32_diff_drive_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const stm32_diff_drive_msgs::msg::MotorCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  stm32_diff_drive_msgs::msg::MotorCommand & ros_message)
{
  // Member: is_pwm
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = stm32_diff_drive_msgs::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const stm32_diff_drive_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<stm32_diff_drive_msgs::msg::MotorCommand *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_stm32_diff_drive_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<stm32_diff_drive_msgs::msg::MotorCommand>()
{
  return &stm32_diff_drive_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_diff_drive_msgs, msg, MotorCommand)() {
  return &stm32_diff_drive_msgs::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
