...
static const _MotorVels_type_support_symbol_names_t _MotorVels_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stm32_diff_drive_msgs, msg, MotorVels)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stm32_diff_drive_msgs, msg, MotorVels)),
  }
};
...
{
  return &::stm32_diff_drive_msgs::msg::rosidl_typesupport_cpp::MotorVels_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stm32_diff_drive_msgs, msg, MotorVels)() {
  return get_message_type_support_handle<stm32_diff_drive_msgs::msg::MotorVels>();
}
